...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    first_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Tên")
    last_name = models.CharField(max_length=255, null=True, blank=True, verbose_name="Họ")
    avatar = models.URLField(null=True, blank=True, verbose_name="Ảnh đại diện")
    email = models.EmailField(unique=True)
    password = models.CharField(max_length=128, null=True, verbose_name="Mật khẩu")
    status = models.PositiveSmallIntegerField(choices=Constants.USER_STATUS, default=3, verbose_name="Trạng thái")
    email_verified = models.BooleanField(default=False, verbose_name="Email đã được xác minh")
    ...
    is_superuser = models.BooleanField(default=False, verbose_name="Siêu quản trị viên")
    last_login = models.DateTimeField(null=True, blank=True, verbose_name="Lần đăng nhập cuối")
    role = models.IntegerField(choices=Constants.ROLE, default=1, verbose_name="Vai trò")
    
    is_verified_doctor = models.BooleanField(default=False, verbose_name="Đã xác minh là bác sĩ")
    # Thông tin xác minh
    license_number = models.CharField(max_length=50, null=True, blank=True, verbose_name="Số giấy phép hành nghề")
    hospital = models.CharField(max_length=255, null=True, blank=True, verbose_name="Nơi công tác")
    verification_file = models.URLField(null=True, blank=True, verbose_name="File xác minh bác sĩ")
